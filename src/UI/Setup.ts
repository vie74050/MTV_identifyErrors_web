...
export function SetupUI() {
    const header = `<div class="mmd instructions">
        <b>Select </b> Click <span class="icon mouse_lf"></span>
        <b>Pan </b>  Drag <span class="icon mouse_lf"></span> or arrow keys 
        <b>Rotate </b> Drag <span class="icon mouse_rt"></span> or A,D 
        <b>Zoom </b>  Scroll <span class="icon mouse_wheel"></span> or W,S
